...
class cq3 extends JFrame  
{
    ...
    cq3() 
	{
		...
		rb1.setBounds(120,220,50,62);
		rb1.setFont(customFont1);
		rb2 = new JRadioButton( );
		rb2.setBounds(120,306,50,62);
		rb2.setFont(customFont1);
		rb3 = new JRadioButton();
		rb3.setBounds(120,387,50,62);
		rb3.setFont(customFont1);
		rb4 = new JRadioButton();
		rb4.setBounds(120,474,50,62);
		...
		ImageIcon imageIcon = new ImageIcon("q3.jpeg");
