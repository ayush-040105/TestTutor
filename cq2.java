...
class cq2 extends JFrame  
{
    ...
    cq2() 
	{
		...
		rb1.setBounds(120,227,50,62);
		rb1.setFont(customFont1);
		rb2 = new JRadioButton( );
		rb2.setBounds(120,316,50,62);
		rb2.setFont(customFont1);
		rb3 = new JRadioButton();
		rb3.setBounds(120,402,50,62);
		rb3.setFont(customFont1);
		rb4 = new JRadioButton();
		rb4.setBounds(120,486,50,62);
		...
		ImageIcon imageIcon = new ImageIcon("q2.jpeg");
